...
USING csv
OPTIONS(header "false", delimiter "|", path "${DATA_DIR}/call_center.dat")
;
...
USING csv
OPTIONS(header "false", delimiter "|", path "${DATA_DIR}/catalog_page.dat")
;
...
USING csv
OPTIONS(header "false", delimiter "|", path "${DATA_DIR}/catalog_returns.dat")
;
...
USING csv
OPTIONS(header "false", delimiter "|", path "${DATA_DIR}/catalog_sales.dat")
;
...
USING csv
OPTIONS(header "false", delimiter "|", path "${DATA_DIR}/customer.dat")
;
...
USING csv
OPTIONS(header "false", delimiter "|", path "${DATA_DIR}/customer_address.dat")
;
...
USING csv
OPTIONS(header "false", delimiter "|", path "${DATA_DIR}/customer_demographics.dat")
;
...
USING csv
OPTIONS(header "false", delimiter "|", path "${DATA_DIR}/date_dim.dat")
;
...
USING csv
OPTIONS(header "false", delimiter "|", path "${DATA_DIR}/household_demographics.dat")
;
...
USING csv
OPTIONS(header "false", delimiter "|", path "${DATA_DIR}/income_band.dat")
;
...
USING csv
OPTIONS(header "false", delimiter "|", path "${DATA_DIR}/inventory.dat")
;
...
USING csv
OPTIONS(header "false", delimiter "|", path "${DATA_DIR}/item.dat")
;
...
USING csv
OPTIONS(header "false", delimiter "|", path "${DATA_DIR}/promotion.dat")
;
...
USING csv
OPTIONS(header "false", delimiter "|", path "${DATA_DIR}/reason.dat")
;
...
USING csv
OPTIONS(header "false", delimiter "|", path "${DATA_DIR}/ship_mode.dat")
;
...
USING csv
OPTIONS(header "false", delimiter "|", path "${DATA_DIR}/store.dat")
;
...
USING csv
OPTIONS(header "false", delimiter "|", path "${DATA_DIR}/store_returns.dat")
;
...
USING csv
OPTIONS(header "false", delimiter "|", path "${DATA_DIR}/store_sales.dat")
;
...
USING csv
OPTIONS(header "false", delimiter "|", path "${DATA_DIR}/time_dim.dat")
;
...
USING csv
OPTIONS(header "false", delimiter "|", path "${DATA_DIR}/warehouse.dat")
;
...
USING csv
OPTIONS(header "false", delimiter "|", path "${DATA_DIR}/web_page.dat")
;
...
USING csv
OPTIONS(header "false", delimiter "|", path "${DATA_DIR}/web_returns.dat")
;
...
USING csv
OPTIONS(header "false", delimiter "|", path "${DATA_DIR}/web_sales.dat")
;
...
USING csv
OPTIONS(header "false", delimiter "|", path "${DATA_DIR}/web_site.dat")
;
